...
import { Home, DollarSign, MapPin, Building, Image as ImageIcon, Upload, ArrowRight, CheckCircle2, Calendar } from "lucide-react";
...
function Rent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      alert(err.response?.data?.message || "Error saving rental property");
    } finally {
      setUploading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Fill in the details below to list your rental property. Find tenants quickly.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input 
                  ...
                  placeholder="e.g., Spacious 2BHK for Rent" 
            ...
            <div className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all" 
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all resize-none" 
                  rows={5}
                />
              </div>
            </div>
          ...
          <section className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-8 text-center hover:border-green-500 dark:hover:border-green-400 transition-colors">
              <input 
                ...
                id="file-upload-rent" 
              />
              <label htmlFor="file-upload-rent" className="cursor-pointer">
              ...
              {uploading && <div className="text-sm text-green-600 dark:text-green-400 mt-4">Uploading images…</div>}
          ...
          <section className="bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-3xl p-6 border border-green-100 dark:border-green-800">
          ...
          <button 
            type="submit" 
            disabled={uploading} 
            className="w-full py-4 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white font-bold text-lg rounded-2xl shadow-lg shadow-green-500/30 transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {uploading ? "Processing…" : "Submit Rental Property"}
            <ArrowRight size={20} />
          </button>
        </form>
      </div>
